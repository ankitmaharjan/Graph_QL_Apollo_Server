...
import Comment from '../../models/comment'; // Make sure to import your Comment model here
import User from '../../models/user'; // Make sure to import your User model here
import Post from '../../models/post'; // Make sure to import your Post model here
import Reply from '../../models/reply'; // Make sure to import your Reply model here
import { createCommentInterface, deleteInterface } from '../../interfaces';
